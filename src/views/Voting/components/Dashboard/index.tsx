                ...
                <div className="container">
                    ...
                    <div className="lg:col-span-10">
                        <div className="banner-content text-center" data-aos="fade-up">
                            ...
                            <a className="button inline-block button-gradient border-2 border-white px-8 py-3 text-coolGray-200 text-lg font-bold rounded-full shadow transition duration-500"
                                href="#">Learn more</a>
                        </div>
                    </div>
                    </div>
