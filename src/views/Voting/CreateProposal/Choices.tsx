  ...
  return (
    <Card>
      ...
      <CardBody style={{ background: 'rgba(10,0,6,0.8)' }}>
        ...
        <Button type="button" onClick={addChoice} disabled={!hasMinimumChoices} className='button inline-block button-gradient border-2 border-white px-8 py-3 text-coolGray-200 text-lg font-bold rounded-full shadow transition duration-500'>
          {t('Add Choice')}
        </Button>
      </CardBody>
    </Card>
